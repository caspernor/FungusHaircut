...
const features = [
  {
    description: [
      ...
      'Hår er blevet min livsstil. Mit arbejde som frisør betyder alt for mig, og mange af mine fritidsinteresser er relateret til mit fag. Jeg rejser til udlandet hvert år for at finde inspiration og undergrundstendenser til min profession.',
        ...
        <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 sm:gap-y-20 lg:mx-0 lg:max-w-none lg:grid-cols-2">
          <div className="lg:pr-8 lg:pt-4">
            <div className="lg:max-w-lg">
              <p className="mt-2 text-3xl font-bold tracking-tight text-cream sm:text-4xl">Karim Belkhelfa</p>
