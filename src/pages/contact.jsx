export default function Example() {
    return (
      ...
      <div className="hidden md:absolute inset-0 mt-16 mx-4 mb-4 border-8 rounded-xl border-cream" />
      <div className="hidden md:absolute inset-6 mt-16 mx-4 mb-4 border-4 rounded-xl border-cream opacity-70" />
      <div className="hidden md:absolute inset-12 mt-16 mx-4 mb-4 border-2 rounded-xl border-cream opacity-40" />
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-2xl space-y-16 divide-y divide-gray-100 lg:mx-0 lg:max-w-none">
            <div className="grid grid-cols-1 gap-x-8 gap-y-10 pt-16 lg:grid-cols-3">
              <div>
                <h2 className="text-3xl font-bold tracking-tight text-white" style={{ textShadow: '1px 1px 2px rgba(0, 0, 0, 0.2)' }}>Get in touch</h2>
                <p className="mt-4 leading-7 text-cream" style={{ textShadow: '1px 1px 2px rgba(0, 0, 0, 0.2)' }}>
              ...
              <div className="grid grid-cols-2 gap-6 sm:grid-cols-2 lg:col-span-2 lg:gap-8">
                <div className="rounded-2xl border-2 border-gray-50 p-10">
                  <h3 className="text-base font-semibold leading-7 text-white" style={{ textShadow: '1px 1px 2px rgba(0, 0, 0, 0.2)' }}>Telefon</h3>
                  <dl className="mt-3 space-y-1 text-sm leading-6 text-cream" style={{ textShadow: '1px 1px 2px rgba(0, 0, 0, 0.2)' }}>
                    <div className="mt-1">
            ...
            <div className="grid grid-cols-1 gap-x-8 gap-y-10 pt-16 lg:grid-cols-3">
              <div>
                <h2 className="text-3xl font-bold tracking-tight text-white" style={{ textShadow: '1px 1px 2px rgba(0, 0, 0, 0.2)' }}>Lokation</h2>
                <p className="mt-4 leading-7 text-cream" style={{ textShadow: '1px 1px 2px rgba(0, 0, 0, 0.2)' }}>
                Vi holder til i hjertet af København N.
                </p>

                <br></br>
            <div className="relative rounded-full px-3 py-1 text-sm leading-6 text-cream ring-1 ring-white/10 hover:ring-white/20 text-center" style={{ textShadow: '1px 1px 2px rgba(0, 0, 0, 0.2)' }}>
                Få vist vej til salonen her:{' '}
                <a href="https://goo.gl/maps/rUeyLt64drhZN4UL7" className="font-semibold text-white" style={{ textShadow: '1px 1px 2px rgba(0, 0, 0, 0.2)' }}>
              ...
              <div className="grid grid-cols-2 gap-6 sm:grid-cols-2 lg:col-span-2 lg:gap-8">
                <div className="rounded-2xl border-2 border-gray-50 p-10">
                  <h3 className="text-base font-semibold leading-7 text-white" style={{ textShadow: '1px 1px 2px rgba(0, 0, 0, 0.2)' }}>Elmegade 10</h3>
                  <address className="mt-3 space-y-1 text-sm not-italic leading-6 text-cream" style={{ textShadow: '1px 1px 2px rgba(0, 0, 0, 0.2)' }}>
